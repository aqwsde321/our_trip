			...
			<div class="bbs">
				...
				<div class="pagenate clear">
					...
					<c:forEach var="num" begin="${data.startPage }" end="${data.endPage }">
						<li><a href="${num }" class="${qnaVO.page == num? 'current' : '' }">${num }</a></li>
						<%-- <li><a href="${num }" <c:if test="${boardVO.page == num }">class='current'</c:if>>${num }</a></li> --%>
					</c:forEach>
				...
				<div class="bbsSearch">
					...
					<form id="actionForm" action="main.do" method="get">
						<input type="hidden" name="page" value="${qnaVO.page}">
						<input type="hidden" name="pageRow" value="${qnaVO.pageRow}">
